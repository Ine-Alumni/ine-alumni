      ...
      <DropdownMenuContent className="w-48 mt-2">
        {!auth ? (
          <>
            ...
            <DropdownMenuItem><Link to="/se-connecter" className="w-full">Connexion</Link></DropdownMenuItem>
            <DropdownMenuItem><Link to="/nouveau-compte" className="w-full">S'inscrire</Link></DropdownMenuItem>
          </>
        ) : (
          <>
            <DropdownMenuItem><Link to="/" className="w-full">Accueil</Link></DropdownMenuItem>
