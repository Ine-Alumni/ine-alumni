          ...
          <div className="space-y-3">
            {isEditing ? (
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                {profile.about ||
                  "Aucune description disponible. Cliquez sur modifier pour ajouter une description."}
              </p>
            )}
          </div>
        );
            ...
            {profile.competences.length > 0
              ...
              : !isEditing && (
                  <p className="text-gray-500 text-sm">
                    Aucune compétence ajoutée. Cliquez sur modifier pour en
                    ajouter.
                  </p>
                )}
            {isEditing && (
        ...
        return (
          <div className="space-y-4">
            {profile.experiences.length > 0
                    ...
                    <div className="flex-1">
                      {isEditing ? (
                        <div className="space-y-2">
                          ...
                          <button
                            onClick={() =>
                              handleDeleteItem("experiences", exp.id)
                            }
                        ...
                        <>
                          ...
                          <p className="text-[#3A7FC2] text-xs mt-0.5">
                            {exp.period}
                          </p>
                        </>
                      )}
              ...
              : !isEditing && (
                  <p className="text-gray-500 text-sm">
                    Aucune expérience ajoutée. Cliquez sur modifier pour en
                    ajouter.
                  </p>
                )}
        ...
        return (
          <div className="space-y-4">
            {profile.formation.length > 0
                    ...
                    <div className="flex-1">
                      {isEditing ? (
                        <div className="space-y-2">
                          ...
                          <button
                            onClick={() =>
                              handleDeleteItem("formation", form.id)
                            }
                            className="text-red-500 text-xs hover:text-red-700"
                          >
                            Supprimer
              ...
              : !isEditing && (
                  <p className="text-gray-500 text-sm">
                    Aucune formation ajoutée. Cliquez sur modifier pour en
                    ajouter.
                  </p>
                )}
            <div className="flex justify-center">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-8 relative">
          <div className="flex gap-6 items-start">
            <div className="flex-shrink-0">
              ...
              <p className="text-xs text-[#3A7FC2] text-center mt-2">
                ...
                <button
                  onClick={() => {
                    if (!profile.socialLinks.github) {
                      alert(
                        "Veuillez remplir votre lien GitHub en cliquant sur modifier",
                      );
                    } else {
                ...
                <button
                  onClick={() => {
                    if (!profile.socialLinks.linkedin) {
                      alert(
                        "Veuillez remplir votre lien LinkedIn en cliquant sur modifier",
                      );
                    } else {
                ...
                <button
                  onClick={() => {
                    if (!profile.socialLinks.whatsapp) {
                      alert(
                        "Veuillez remplir votre numéro WhatsApp en cliquant sur modifier",
                      );
                    } else {
                      window.open(
                        `https://wa.me/${profile.socialLinks.whatsapp}`,
                        "_blank",
                      );
                    }
                  }}
                ...
                <button
                  onClick={() => {
                    if (!profile.socialLinks.email) {
                      alert(
                        "Veuillez remplir votre email en cliquant sur modifier",
                      );
                    } else {
