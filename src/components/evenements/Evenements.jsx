    ...
    try {
      ...
      setEvents(prev => [
        ...prev,
        {
          ...
          progress: 0,
          price: 0,
          image: `http://localhost:8080${newEvent.image}`,
          schedule: newEvent.schedule,
 ...
 const filteredEvents = events.filter((event) => {
  ...
  const matchesCalendarDate = selectedCalendarDate
    ...
    : true;
      ...
      console.log("event.date:", event.date, "selectedCalendarDate:", selectedCalendarDate, "match:", matchesCalendarDate);

  return matchesFilter && matchesSearch && matchesDateRange && matchesCalendarDate;
});
  ...
  return (
    <div className="p-6 font-sans bg-white">
      <div className="bg-[#fafafa] rounded-xl py-10 px-4 mb-8 text-center">
        <h1 className="text-4xl font-extrabold text-gray-800">Nos Événements</h1>
        ...
        <div className="flex flex-wrap md:flex-nowrap gap-4 items-center justify-between mb-8">
          <div className="flex gap-2">
            {filters.map((filter) => (
              ...
              >
                {filter} ({events.filter((e) => filter === 'All' || e.status === filter).length})
              </button>
            ))}
          </div>
                ...
                <div className="absolute top-12 right-0 z-50">
                  ...
                  className="bg-white p-4 rounded-2xl shadow-xl border border-gray-200 w-72">
                    <div slot="previous" className="absolute left-2 top-3 cursor-pointer">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 text-gray-700 hover:text-[#5691cb]">
            ...
            >
              ...
              <div className="p-4">
                ...
                <h3 className="text-lg font-semibold flex items-center gap-2">
                  {event.title}
                  {isSoon(event.date) && (
                    <span className="text-xs text-orange-500 font-semibold">Bientôt</span>
                  )}
                </h3>
                ...
                <div className="mt-3 flex flex-col gap-2">
                  <a
                    href={`https://www.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent(
                      event.title
                    )}&dates=${event.date.replace(/[-:]/g, '').replace('T', '')}/${event.date
                      .replace(/[-:]/g, '')
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                <label className="block text-gray-700 mb-2">Planning / Schedule</label>
                <textarea
                  name="schedule"
...
/>
  ...
  <div className="mb-4">
    ...
    <img
      src={`http://localhost:8080${newEvent.image}`}
      alt="Aperçu"
    ...
    />
              ...
              <div className="mb-4">
                <label className="block text-gray-700 mb-2">À quoi s’attendre ?</label>
                <textarea
                  name="whatToExpect"
