...
const PrivateSection1 = () => {
  return (
    <div className='relative w-full h-full'>
      <div className='absolute inset-0 bg-[url("/assets/bg.jpg")] bg-cover bg-center opacity-10'></div>

      <div className='relative z-10 mx-[12vw] flex justify-center items-center gap-58 py-20 max-lg:flex-col'>
        ...
        <Carousel className='max-w-120' opts={{ align: "center", loop: true }}>
          <CarouselContent>
            <CarouselItem>
              <img
                className='rounded-2xl h-68 max-sm:h-auto'
...
export default PrivateSection1
