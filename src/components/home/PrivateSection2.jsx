        ...
        <div>
            ...
            <div className='mt-16 mx-[12vw] flex flex-wrap gap-y-12 gap-12 justify-center'>
                <div className="w-72 bg-white shadow-md rounded-lg border p-6 flex flex-col items-center text-center transform transition-transform duration-300 hover:scale-105 focus-within:scale-105">
                    ...
                    <Link to='/private-home/stages' className="border-2 border-[#34699A] text-[#34699A] px-4 py-1 rounded font-semibold hover:bg-[#34699A] hover:text-white transition">Voir les offres</Link>
                </div>
                ...
                <div className="w-72 bg-white shadow-md rounded-lg border p-6 flex flex-col items-center text-center transform transition-transform duration-300 hover:scale-105 focus-within:scale-105">
                    ...
                    <Link to='/private-home/emplois' className="border-2 border-[#34699A] text-[#34699A] px-4 py-1 rounded font-semibold hover:bg-[#34699A] hover:text-white transition">Explorer les offres</Link>
                </div>
                ...
                <div className="w-72 bg-white shadow-md rounded-lg border p-6 flex flex-col items-center text-center transform transition-transform duration-300 hover:scale-105 focus-within:scale-105">
                    ...
                    <Link to='/private-home/evenements' className="border-2 border-[#34699A] text-[#34699A] px-4 py-1 rounded font-semibold hover:bg-[#34699A] hover:text-white transition">Voir le calendrier</Link>
                </div>
            ...
            <div className="mt-10 mx-[12vw] flex flex-wrap gap-y-12 gap-12 justify-center">
                ...
                <div className="w-72 bg-white shadow-md rounded-lg border p-6 flex flex-col items-center text-center transform transition-transform duration-300 hover:scale-105 focus-within:scale-105">
                    ...
                    <Link to='/private-home/ressources' className="border-2 border-[#34699A] text-[#34699A] px-4 py-1 rounded font-semibold hover:bg-[#34699A] hover:text-white transition">Voir les ressources</Link>
                </div>
                ...
                <div className="w-72 bg-white shadow-md rounded-lg border p-6 flex flex-col items-center text-center transform transition-transform duration-300 hover:scale-105 focus-within:scale-105">
                    ...
                    <Link to='/private-home/laureats' className="border-2 border-[#34699A] text-[#34699A] px-4 py-1 rounded font-semibold hover:bg-[#34699A] hover:text-white transition">Explorer</Link>
                </div>
                ...
                <div className="w-72 bg-white shadow-md rounded-lg border p-6 flex flex-col items-center text-center transform transition-transform duration-300 hover:scale-105 focus-within:scale-105">
                    ...
                    <Link to='/private-home/entreprises' className="border-2 border-[#34699A] text-[#34699A] px-4 py-1 rounded font-semibold hover:bg-[#34699A] hover:text-white transition">Consulter</Link>
                </div>
...
export default PrivateSection2