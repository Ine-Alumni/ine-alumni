        ...
        <div className="flex flex-col items-center justify-center px-6 py-20 mx-auto">
            <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-xl xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <h1 className="text-xl font-bold leading-tight tracking-tight text-[#2c6aab] 
                    ...
                    <form noValidate onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                        ...
                        <div className='max-sm:space-y-4 sm:grid sm:grid-cols-2 sm:gap-6'>
                            <div>
                        ...
                        <button disabled={isSubmitting===true} type="submit" className="w-full text-white bg-[#3A7FC2] hover:bg-[#2c6aab] mt-3 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-bold rounded-lg text-sm px-5 py-3 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 cursor-pointer">S'inscrire</button>
                        <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                            Vous avez déjà un compte ? <Link to="/se-connecter" className="font-medium text-[#3A7FC2] hover:underline dark:text-primary-500 ">Se connecter</Link>
                        </p>
                    </form>
                </div>
            </div>
