        ...
        <div className="flex flex-col items-center justify-center px-6 py-20 mx-auto">
            <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <h1 className="text-xl font-bold leading-tight tracking-tight text-[#2c6aab] md:text-2xl dark:text-white">
                        Se connecter 
                    </h1>
                    <form noValidate onSubmit={handleSubmit} className="space-y-4 md:space-y-6" action="#">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <a href="#" className="text-sm font-medium text-[#3A7FC2] hover:underline dark:text-primary-500">Mot de passe oublié ?</a>
                        </div>
                        <button disabled={isSubmitting===true} type="submit" className="w-full text-white bg-[#3A7FC2] hover:bg-[#2c6aab] focus:ring-4 focus:outline-none focus:ring-primary-300 font-bold rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 cursor-pointer hover:bg-[#0c5f95]">Se connecter</button>
                        <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                            Vous n'avez pas encore de compte ? <Link to="/nouveau-compte" className="font-medium text-[#3A7FC2] hover:underline dark:text-primary-500">S'inscrire</Link>
                        </p>
                    </form>
                </div>
            </div>
