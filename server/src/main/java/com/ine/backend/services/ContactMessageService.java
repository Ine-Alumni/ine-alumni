...
public class ContactMessageService {
	...
	private String buildAdminEmailBody(ContactMessageRequestDto request) {
		return String.format("Nouveau message depuis le formulaire de contact INE Alumni\n\n"
				...
				request.getNom(), request.getPrenom(), request.getEmail(), request.getObjet(), request.getMessage());
	}
	...
	private String buildUserEmailBody(ContactMessageRequestDto request) {
		return String.format("Bonjour %s %s,\n\n" + "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
				...
				request.getPrenom(), request.getNom(), request.getObjet());
	}
}