  ...
  return (
    <div className="bg-[#053A5F] px-[12vw] pt-11 pb-6 text-white">
      <div className="flex gap-8 justify-between flex-wrap gap-y-6">
        <div>
          <img
            src="/assets/ine_alumni_white.png"
            alt="ine alumni logo"
            className="h-20"
          />
          {/* <h1 className='mt-4 text-xl font-bold'>Ine Alumni</h1> */}
          <p className="max-w-45 text-sm mt-5">
        ...
        <div>
          ...
          <a href="tel:212512345678" className="mt-2 block underline">
            +212 5 12 34 56 78
          </a>
          <a href="mailto:info@inealumni.ac.ma" className="mt-0 underline">
            info@inealumni.ac.ma
          </a>
        </div>
      </div>
      <div className="h-[1px] bg-slate-200 w-[76vw] text-center mt-8"></div>
      <p className="mt-4 text-gray-300 text-sm text-center">
        &#169; 2025 INPT ALUMNI. Tous droits réservés.
      </p>
    </div>
  );
};
