    ...
    return description.split("\n").map((paragraph, index) => {
      if (paragraph.startsWith("**") && paragraph.endsWith("**")) {
        ...
        return (
          <h3
            key={index}
            className="font-semibold text-[#053A5F] mt-6 mb-3 first:mt-0 text-lg"
          >
            {paragraph.slice(2, -2)}
          </h3>
        );
  ...
  return (
    <div className="space-y-6 pb-8">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-4">
            <div className="space-y-3">
              <div className="flex items-center gap-3 flex-wrap">
                <CardTitle
                  className="text-2xl text-[#053A5F] font-bold"
              ...
              <div
                className="flex flex-col sm:flex-row gap-4 text-[#3A7FC2] flex-wrap"
                style={{ fontFamily: "Open Sans, sans-serif" }}
              >
      ...
      <Card className="bg-white border-2 border-[#0C5F95] shadow-md">
        <CardHeader className="bg-gray-50 border-b border-gray-200">
          <CardTitle
            className="text-xl text-[#053A5F] font-semibold"
            style={{ fontFamily: "Open Sans, sans-serif" }}
          >
            {t("job.description")}
          </CardTitle>
            ...
            */}
            ...
            {(job.externalLink || job.link) && (
              <Button
                variant="outline"
                onClick={() =>
                  window.open(job.externalLink || job.link, "_blank")
                }
